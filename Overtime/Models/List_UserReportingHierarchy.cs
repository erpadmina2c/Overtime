...
{
    public class List_UserReportingHierarchy
    {
        [Key]
        ...
        [Display(Name = "User")]
        public string? urh_u_id_name { get; set; }

        [Display(Name = "Reporting to")]
        public int urh_reporting_to { get; set; }

        [Display(Name = "Reporting to")]
        public string? urh_reporting_to_name { get; set; }
        ...
        [Display(Name = "Created by")]
        public string? urh_cre_by_name { get; set; }
